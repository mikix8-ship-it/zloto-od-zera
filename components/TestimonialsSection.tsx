  ...
  const testimonials = [
    {
      ...
      text: "Czytałem e-book. Poszedłem do dealera ze skryptem z e-booka. Dealer się rozkleił - okazało się że sprzedaje fałszywkę. Oszczędziłem sobie 5,000 PLN na pierwszym zakupie.\n\nKiedy czytam wiele artykułów online - wszystko jest sprzeczne. E-book wyjaśnia CZEMU tak, a nie inaczej.\n\nPolecam.",
    ...
    },
    {
      ...
      text: "Czytałem wiele e-booków o inwestycjach. Ten jest inny. Zawiera więcej niż książka za 80 zł. Cena 49,99 zł to SKOK okazji.\n\nBonus materiały są naprawdę przydatne - szczególnie arkusz DCA i kalkulator podatków.\n\nDziękuję Adam.",
